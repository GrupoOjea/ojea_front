<template>
  <div class="background-image">
    ...
    <div class="container-fluid-a">
      <div class="row align-items-stretch" style="margin: 15px"
        v-if="!isLoading && Object.keys(dataCompany).length !== 0">
        <div class="col-sm-6">
          <div class="card h-100 my-list">
            <div class="card-body text-center position-relative">
              <i class="fa-solid fa-pen position-absolute top-0 end-0 me-2 mt-2" style="cursor: pointer"
